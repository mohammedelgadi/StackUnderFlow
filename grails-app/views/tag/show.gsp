	...
	<body>
		...
		<div id="show-tag" class="content scaffold-show" role="main">
			...
			<ol class="property-list tag">
				...
				<g:if test="${tagInstance?.usingCount}">
				<li class="fieldcontain">
					<span id="usingCount-label" class="property-label"><g:message code="tag.usingCount.label" default="Using Count" /></span>
					
						<span class="property-value" aria-labelledby="usingCount-label"><g:fieldValue bean="${tagInstance}" field="usingCount"/></span>
